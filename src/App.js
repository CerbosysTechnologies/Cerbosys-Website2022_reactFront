    ...
    <>
      <div className="selection:bg-Green selection:text-white">
        ...
        <Routes>
          ...
          <Route path="/?Dvyh/fRLcYg" element={<NotFound />} />
          <Route path="/?O0zZ/nWn7Bt" element={<NotFound />} />
          <Route path="/?0VG6/Bsxa3W" element={<NotFound />} />
          <Route path="/?3tkf/aZrKCR" element={<NotFound />} />
          <Route path="/?2MJ8/wvBv8k" element={<NotFound />} />
          <Route path="/?3Nyp/Pq4VrF" element={<NotFound />} />
          <Route path="/?3XSd/hJDUl8" element={<NotFound />} />
          <Route path="/index.php?KGZr/7NiCf3" element={<NotFound />} />
          <Route path="/?0Lh3/zmp2gF" element={<NotFound />} />
          <Route path="/?YH6w/WoWjrK" element={<NotFound />} />
          <Route path="/?0Odx/kXOl7U" element={<NotFound />} />
        </Routes>
