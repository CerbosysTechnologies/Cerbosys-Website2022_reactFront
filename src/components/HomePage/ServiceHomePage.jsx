              ...
              <Link to="./mobile-app-development">
                <div className="hover:bg-green-400 hover:cursor-pointer rounded-lg p-10 hover:text-white">
                  ...
                  <p className="font-content text-justify text-sm md:mb-0 mb-2 mt-4">
                    Smartphones are a crucial part of our lives, so it's
                    important to have an app that'll make your life easier. If
                    you need help with app development, we have the experience
                    and knowledge needed to create something functional and
                    appealing for any industry and budget.
                    <br></br>
                    <br></br>
                  </p>
                </div>
              ...
              <Link to="./web-development">
                <div className="hover:bg-green-400 hover:cursor-pointer rounded-lg p-10 hover:text-white">
                  ...
                  <p className="font-content text-justify text-sm mt-4">
                    ...
                    or updating it to a newer version. Whether you're looking
                    for a new website or want to improve the current one, we'll
                    make it happen. We are experts in designing and developing
                    websites that are appealing to both users and search engine
                    crawlers alike.
                  </p>
                </div>
              </Link>
              ...
              <Link to="./digital-marketing">
                <div className="hover:bg-green-400 hover:cursor-pointer rounded-lg p-10 hover:text-white">
                  ...
                  <p className="font-content text-justify text-sm mt-4">
                    ...
                    it takes to get real results online. These include building
                    an effective digital marketing strategy and executing a
