...
import icon4 from '../../assets/clientlogo/4.png';
import icon5 from '../../assets/clientlogo/5.png';
import icon6 from '../../assets/clientlogo/6.png';
import icon7 from '../../assets/clientlogo/7.png';
...
import icon13 from '../../assets/clientlogo/15.png';
...
const ClientLogoSlider = () => {
  ...
  return (
    <div className="flex flex-wrap items-center z-[-15]">
      <Swiper
        className="md:h-64 h-72    md:w-96 xl:w-full "
        ...
        {featuredicons.map((slideContent, index) => (
          <SwiperSlide key={slideContent} virtualIndex={index}>
            <img
              ...
              className="w-40 h-36 mt-10 mx-6 "
            />
          </SwiperSlide>
        ))}
      </Swiper>
