      ...
      <div className="max-w-[1240px] mx-auto ">
        <div className="sm:m-10 m-10">
          ...
          <div className="font-subheading text-justify">
            At Cerbosys, accessible from www.cerbosys.com, one of our main
            priorities is the privacy of our visitors. This Privacy Policy
            document contains types of information that is collected and
            recorded by Cerbosys and how we use it. If you have additional
            ...
            www.cerbosys.com. This policy is not applicable to any information
          ...
          <div className="font-subheading text-justify">
            Like any other website, www.cerbosys.com uses 'cookies'. These
          ...
          <div className="font-subheading text-justify">
            ...
            advertising partners of www.cerbosys.com. <br />
            Third-party ad servers or ad networks use technologies like cookies,
            JavaScript, or Web Beacons that are used in their respective
            advertisements and links that appear on www.cerbosys.com, which are
          ...
          <div className="font-subheading text-justify">
            www.cerbosys.com's Privacy Policy does not apply to other
