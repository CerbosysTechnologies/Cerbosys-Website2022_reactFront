...
import contact_icon from '../../../../assets/innerpage/traininganddevelopment/contact_image.png'
import ServicesForm from '../../../Common/Component/ServicesForm'
import { IMAGE_SERVER } from "../../../../ServerUrls";

const TrainingAndDevelopmentForm = ({ onChangeSelected }) => {
          ...
          <div className="flex flex-col flex-wrap items-center">
            ...
            {/* Heading Ends */}
             ...
             <div className="grid md:grid-cols-2 mb-4 mt-10 md:w-10/12 shadow-xl shadow-gray-600">
              ...
              <img  src={!imgName ? contact_icon : imgName}
              alt="" className="md:h-full"></img>
              </div>
              {/* Image Section Ends*/}
