              ...
              >
                <SwiperSlide>
                  ...
                  <p className="font-subheading md:text-lg text-sm mx-5  text-justify">
                    ...
                    helped us reach new heights. They have been extremely
                    helpful and very friendly throughout the process. Their team
                    is very responsive and willing to go above and beyond for
                    their customers.
                  </p>
                ...
                <SwiperSlide>
                  ...
                  <p className="font-subheading md:text-xl text-sm mx-10 text-justify">
                    ...
                    responsive and the tech is easy to use. I would recommend
                    them to anyone who is looking for a team that can take your
                ...
                <SwiperSlide>
                  ...
                  <p className="font-subheading md:text-xl text-sm mx-10 text-justify">
                    <br></br>
                    Cerbosys team is quick, responsive and incredibly
                    innovative. I can truly write pages on how incredible and
                    valuable their services are, so far it has been an amazing
                ...
                <SwiperSlide>
                  ...
                  <p className="font-subheading md:text-lg text-sm mx-10 text-justify">
                    <br></br>I highly recommend Cerbosys and their team. They
                    are very professional and quick to respond, especially for a
                    small business. They have taken our idea and brought it to
                    life in a matter of weeks, really showing their capabilities
