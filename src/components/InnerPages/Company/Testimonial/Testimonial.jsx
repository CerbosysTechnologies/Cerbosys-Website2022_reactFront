...
const Testimonial = () => {
  return (
    <div>
      <>
        <Helmet>
          <title>Testimonial page - Cerbosys Technologies</title>
          <meta
            name="keywords"
            content="our customers, our clients, testimonial, our business, take your business to the next level, clients testimonials, clients reviews, reviews, business reviews, testimonials, clients feedback, feedback"
          />
          <meta
            name="description"
        ...
        <div className="mx-auto w-full md:h-[40rem]  h-96 py-12 px-4 bg-TestimonialHeader bg-cover md:bg-top bg-center">
          ...
          <div className="flex flex-col justify-center text-center items-center md:h-[30rem] h-96 mx-auto md:mt-20">
            ...
            <p className="text-white font-subheading py-2 md:text-3xl text-xs mb-8 md:w-[980px] text-justify md:mt-52 mt-20">
              The future of events is a story we’re writing together with our
              customers. Let's take a look what our clients have to say
            </p>
          </div>
