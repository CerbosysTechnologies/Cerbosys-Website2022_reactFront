...
import digitalmarketing_formicon from '../../../../assets/innerpage/digitalmarketing/formimage.png'
import { IMAGE_SERVER } from "../../../../ServerUrls";
import { useState } from "react";

const DigitalForm = ({ onChangeSelected }) => {
          ...
          <div className="flex flex-col flex-wrap items-center">
            ...
            {/* Heading Ends */}
             ...
             <div className="grid md:grid-cols-2  mb-4 mt-10 shadow-xl shadow-gray-600">
              {/* Image Section */}
              <div className="">
              <img src={!imgName ? digitalmarketing_formicon : imgName} alt="" className="h-full"></img>
              </div>
              {/* Image Section Ends*/}
