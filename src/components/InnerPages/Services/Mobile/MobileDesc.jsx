          ...
          <div className="grid md:grid-cols-2">
            ...
            <div className="mx-auto flex flex-col md:px-24 px-14 text-justify">
              ...
              <p className="font-content md:text-lg text-sm">
                ...
                providing a good user experience. With the advancement in mobile
                app development technology, we can provide you with a wide range
                of services through our app development programs.
              </p>
            </div>
