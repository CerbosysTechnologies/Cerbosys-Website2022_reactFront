...
import Softwaredevelopment from '../../../../assets/innerpage/Softwaredevelopment/softwareDevlopement.jpg';
import ServicesForm from '../../../Common/Component/ServicesForm';
import { IMAGE_SERVER } from '../../../../ServerUrls';
import { useState } from 'react';
function SoftwareDForm({ onChangeSelected }) {
          ...
          <div className="flex flex-col flex-wrap items-center">
            ...
            <div className="grid md:grid-cols-2 mb-4 mt-10 shadow-xl shadow-gray-600">
              ...
              <div className="mx-auto items-center justify-center ">
                <img
                  src={!imgName ? Softwaredevelopment : imgName}
                  alt=""
                  className="h-full"
                ></img>
              </div>
