          ...
          <div className="grid md:grid-cols-2 bg-Primary mt-8 rounded-3xl gap-2">
            ...
            <div className="flex flex-col md:px-24 px-14 mx-auto text-justify mt-8">
              ...
              <p className="font-content md:text-lg text-sm mb-8 text-white mt-3 ">
                ...
                <br></br>
                <br></br>
                Since,UI/UX development is the process of creating user interfaces and
                user experiences for software applications, our main focus is on
                building robust, high-performance user experiences for software
                applications.
              </p>
            </div>
            {/* Content Section Ends*/}
