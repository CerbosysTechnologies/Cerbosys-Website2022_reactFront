      ...
      <div className="bg-Service mx-auto w-full py-16 px-4 ">
        <div className="max-w-[1240px] mx-auto ">
          <div className="flex flex-wrap flex-col">
            ...
            <img src={angularimage} alt="Dot Net Image" className="md:mt-16 mt-8" />
            ...
            <p className="font-subheading md:text-2xl text-sm text-justify md:mt-10">
              ...
              <br></br>
              <br></br>
              No matter what your needs are, we can help you find the right Angular
              developer for your project. We have a wide range of developers who
              are experts in different areas, so you can be sure to find the
