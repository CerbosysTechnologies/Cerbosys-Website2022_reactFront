...
import contact_icon from '../../../../assets/innerpage/agriculture/contact_image.png';
import { IMAGE_SERVER } from '../../../../ServerUrls';
import { useState } from 'react';

const AgricultureForm = ({ onChangeSelected }) => {
  ...
  return (
    <div>
      <div className="selection:bg-Green selection:text-white bg-FormBackground mx-auto w-full py-16 px-2 object-contain bg-cover bg-center">
