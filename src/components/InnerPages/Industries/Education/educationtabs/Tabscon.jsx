                  ...
                  >
                    <div className="flex justify-between flex-col md:flex-row content-center items-center gap-6 text-white">
                      <div className="md:w-[50%] w-[100%]">
                        {' '}
                        <p className=" font-subheading text-justify mt-4">
                          Augmented and Virtual Reality are two technologies
                          that can be used in the education sector.
                        </p>
                        <p className="font-subheading text-justify mt-6">
                          Augmented Reality (AR) is a technology that overlays
                          digital information on real-world environments, such
                          as buildings or landscapes. This means that users can
                          see information about a place through their smartphone
                          or tablet screen.
                        </p>
                        <p className="font-subheading text-justify mt-6">
