      ...
      <div className="mx-auto w-full md:h-[36rem] bg-MiningHeader h-96 py-12 px-4 bg-cover md:bg-top bg-center">
        ...
        <div className="flex flex-col justify-center text-center items-center md:h-[30rem] h-96 mx-auto">
          ...
          <p className="text-white font-heading py-2 md:text-lg text-xs md:w-[980px] text-justify">
            We believe that mining solutions should be more than just limited to
            designing processes, identifying quality control issues, and
            overseeing safety protocols. It needs to be coordinated with a whole
            new method of doing business. In short, it has to be Synchronized
            Digital Mining (SDM).
          </p>
        </div>
