      ...
      <div className="mx-auto w-full py-10  ">
        ...
        <div className="bg-gradient-to-r from-cyan-600 to-blue-800 py-6">
          <div className="flex flex-wrap justify-center md:flex-nowrap  px-12">
            ...
            <div className=" md:w-[50%] w-[100%] text-white">
              ...
              <p className="font-content   mt-6 text-justify">
                At Cerbosys, we build IT solutions that make your business work
                better. We take our time to get to know you and your company
                before developing a solution that works for both of you.
              </p>
              <p className="font-content   mt-6 text-justify">
                Our team consists of experts in different fields who work
                together with you to create a customized solution that meets
                your needs. Our developers have experience building real estate
                management systems (REMS), software applications, and apps for
                both small businesses and large corporations—but we don't stop
                there! We also specialize in developing custom solutions for
        ...
        <div className="mt-10">
          ...
          <h2 className=" md:text-3xl uppercase text-xl mt-4 font-heading text-center mb-6">
            Our <span className="text-Primary"> Real Estate It Solutions</span>{' '}
