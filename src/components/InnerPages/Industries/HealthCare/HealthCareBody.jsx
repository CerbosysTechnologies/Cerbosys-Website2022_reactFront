        ...
        <div className="flex flex-wrap md:flex-nowrap justify-between items-center md:gap-10 p-6">
          ...
          <div className="p-7">
            ...
            <p className="mt-3 min-w-fit">
              ...
              study that stem from the field of engineering. These two fields
              share a common goal, which is to solve problems by discovering and
              developing new solutions.
            </p>
            <p className="mt-3">
              {' '}
              We are a young but growing company that is dedicated to making the
              lives of doctors easier by giving them a platform & technology
              trends in the healthcare industry where they can easily book
              appointments with patients and manage their schedules.
            </p>
            <p className="mt-3">
