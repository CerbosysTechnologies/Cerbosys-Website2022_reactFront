...
//               <div key={index}
//                 className="p-5  scale-90 hover:scale-100 ease-in duration-500"
//                 onClick={() => SingleBlog(item.blog_id)}
//               // .replace(/\s/g, '-' p-10)
//               >
//                 {/* <!--Card 1--> */}
//                 <div className="max-w-sm h-[100%] rounded-2xl overflow-hidden shadow-2xl cursor-pointer ">
...
//                     <span className="font-subheading text-sm my-5">
