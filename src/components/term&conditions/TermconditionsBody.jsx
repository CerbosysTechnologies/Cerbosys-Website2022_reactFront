  ...
  return (
    <div className="max-w-[1240px] mx-auto ">
      <div className="sm:m-10 m-10">
        ...
        <div className="font-subheading text-justify">
          These Terms of use constitute a legally binding agreement made between
          you, whether personally or on behalf of an entity ("you") and Cerbosys
          ("Company," 'we," 'us," or "our"),concerning your access to and use of
          the https//www.cerbosys.com website.
          <br />
          We are registered in India and have our registered office at Lakshya
          Vihar, Indore, Madhya Pradesh 452016. You agree that by accessing the
        ...
        <ol style={{ listStyle: "outside" }}>
          ...
          <li>
            ...
            whether through a bot, script, or othemise.{" "}
          </li>
          <li>
        ...
        <div className="font-subheading">
          ...
          <br />
          <div className="font-subheading text-justify">
            www.cerbosys.com follows a standard procedure of using log files.
        ...
        <div className="font-subheading">
          ...
          Site and through third-party websites.
          <ul style={{ listStyle: "outside" }} className="font-subheading">
            <li>
        ...
        <div className="font-subheading text-justify">
          Lakshya Vihar, Kanadia road, Indore, Madhya Pradesh India 452016
        </div>
        <div className="font-subheading text-justify">info@cerbosys.com</div>
      </div>
    </div>
  );
}

export default TermconditionsBody;
